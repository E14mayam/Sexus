...
const BlogItems = ({title, article, coverImg}) =>{
  ...
  // }
    ...
    return(
        <div className="blog-post mx-auto col-lg-4 col-md-6 col-sm-12 d-flex flex-column justify-content-between py-3 g-2 px-3">
        <h5 className="h5 px-1">{title}</h5>
        <div className="d-flex userInfo px-1" >
